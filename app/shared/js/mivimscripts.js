...
$(document).ready(function(){
  ...
  //================================================================================
    ...
    $(function(){
      $('#fos-loginform').submit(function(e){
        return false;
      });
      
      $('#fos-modaltrigger').leanModal({ top: 110, overlay: 0.9, closeButton: ".fos-hidemodal" });
    });
  ...
  $('input[name="user-type"]').change(function() {
    ...
    //Show the selected image in the div
    ...
    /* Compose New mail switching*/
    $('.fos-compose-mail').click(function(){

      $('#fos-new-mail').fadeToggle(300);

    });

    //Loading different contents of the tabs
    $("#fos-msg").click(function(){
